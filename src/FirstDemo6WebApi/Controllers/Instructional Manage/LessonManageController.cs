...
namespace FirstDemo6WebApi.Controllers.Auth
{
    ...
    public class LessonManageController : ControllerBase
    {
        ...
        public LessonManageController(UserManager<IdentityUser> userManager, IConfiguration configuration, JwtHelper jwtHelper)
        {
