...
namespace FirstDemo6WebApi.Controllers.Auth
{
    ...
    public class CollegeManageController : ControllerBase
    {
        ...
        public CollegeManageController(UserManager<IdentityUser> userManager, IConfiguration configuration, JwtHelper jwtHelper)
        {
